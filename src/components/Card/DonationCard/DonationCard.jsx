...
const DonationCard = ({donate}) => {
  const {id,image,title,card_bg,text_color,button_bg,category_bg, category} = donate || {};
  return (
    <div className='rounded-lg overflow-hidden flex gap-6' style={{backgroundColor: `${card_bg}`}}>
      ...
      <div className='py-6 flex-1'>
        ...
        <h3 className='mt-2 text-base font-semibold mb-7' style={{color: `${text_color}`}}>$290.00</h3>
