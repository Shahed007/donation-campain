...
const HeroBanner = ({handleSubmit}) => {
  ...
  return (
    ...
    <h1 className="font-bold text-4xl  text-[#0B0B0B] text-center mb-10">I Grow By Helping People In Need</h1>
      ...
      <input id='searchBox'  name="search" className="w-1/2  px-4 py-2 border-2 shadow-md shadow-[#FF444A]/30 border-[#FF444A] rounded-l-lg" placeholder="Search hear" type="text" />
